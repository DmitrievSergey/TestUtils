...
def pytest_addoption(parser):
    ...
    parser.addoption("--url", action="store", default="https://app.sandbox.documo.com")
    parser.addoption("--drivers", action="store", default=os.path.expanduser("~/Downloads/drivers"))
    parser.addoption("--tolerance", type=int, default=10)
    ...
    parser.addoption("--login", type=str, default='')
    parser.addoption("--pwd", type=str, default='')
    parser.addoption("--fax_number", type=str, default='')
    parser.addoption("--fax_count", type=int, default=31)
...
def browser(request):
    ...
    fax_number = request.config.getoption("--fax_number")
    fax_count = request.config.getoption("--fax_count")
    ...
    driver.url = url
    driver.t = tolerance
    driver.fax_number = fax_number
    driver.pwd = pwd
    driver.login = login
    driver.fax_count = fax_count
